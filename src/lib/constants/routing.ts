export const routes = {
	...
	browse_skills:'/home/learn/skills',
	...
	// Hire routes
	hire:'/hire',
	hire_categories:'/hire/categories',
	hire_category:'/hire/category/', // Dynamic route [categoryId]
	professional_detail:'/hire/professional/', // Dynamic route [professionalId]
	post_job:'/hire/post-job',
