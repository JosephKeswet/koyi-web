...
export default function ProfilePage({}: Props) {
  ...
  return (
    <div className="min-h-full screen flex flex-col bg-white">
      <div className="flex flex-col px-5 py-3 bg-white">
      <Link
        href={routes.settings}
        className="lg:hidden flex items-center justify-center w-[32px] h-[32px] md:w-[42px] md:h-[42px] bg-primary-grey rounded-full"
      >
        <ChevronLeft />
      </Link>
